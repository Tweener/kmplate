...
val repositoryModule = module {
    ...
    factory<UserRepository> { UserRepositoryImpl(passage = get(), roomDatabaseHelper = get(), roomExampleDataSource = get(), localStorageDataSource = get(), firestoreUsersDataSource = get()) }
